...
type ItemFunc func(context.Context, *generated.ItemMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ItemFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ItemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.ItemMutation", m)
}

// The ItemImageFunc type is an adapter to allow the use of ordinary
// function as ItemImage mutator.
type ItemImageFunc func(context.Context, *generated.ItemImageMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ItemImageFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ItemImageMutation); ok {
		return f(ctx, mv)
	}
