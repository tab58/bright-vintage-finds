...
func (_q *ItemQuery) QueryOwner() *UserQuery {
...
func (_q *ItemQuery) QueryImages() *ItemImageQuery {
	query := (&ItemImageClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *ItemQuery) WithOwner(opts ...func(*UserQuery)) *ItemQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ItemQuery) WithImages(opts ...func(*ItemImageQuery)) *ItemQuery {
	query := (&ItemImageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ItemQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Item, init func(*Item), assign func(*Item, *User)) error {
...
func (_q *ItemQuery) loadImages(ctx context.Context, query *ItemImageQuery, nodes []*Item, init func(*Item), assign func(*Item, *ItemImage)) error {
	...
	query.withFKs = true
	query.Where(predicate.ItemImage(func(s *sql.Selector) {
