...
func (_q *LabelQuery) loadItems(ctx context.Context, query *ItemQuery, nodes []*Label, init func(*Label), assign func(*Label, *Item)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(item.FieldID), joinT.C(label.ItemsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(label.ItemsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(label.ItemsPrimaryKey[1]))
